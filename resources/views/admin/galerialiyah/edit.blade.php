...
@section('content')
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
      	{!! Form::model($galeri_aliyah,['files'=>true,'method'=>'put','action'=>['admin\GaleriAliyahController@update',$galeri_aliyah->id]]) !!}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("img", "Gambar", ['class' => 'col-md-2 control-label']) }}
             <div class='col-md-4'>
                ...
                <td>
                    <img style="width:70%" src="{{URL::asset('images/galeri/aliyah/'.$galeri_aliyah->img)}}" >
                </td>
              </div>
          </div>
