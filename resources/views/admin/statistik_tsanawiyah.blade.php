...
<table>
  ...
  <tr>
    ...
    <td style="width:10px; text-align: center;">{{ $countSmpMondok }}</td>
    <td style="width:10px; text-align: center;">{{ $countSmpTidakMondok }}</td>
    <td style="width:10px; text-align: center;">{{ $countSmp }}</td>
  </tr>
</table>
@endsection