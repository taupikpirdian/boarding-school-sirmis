...
@section('content')
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        {!! Form::model($acara,['files' => true, 'method'=>'put','action'=>['admin\AcaraController@update',$acara->id]]) !!}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("isi", "Acara", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-9'>
          ...
          <div class='form-group clearfix'>
            {{ Form::label("img", "Gambar", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                ...
                <br><td> <img style="width:30%" src="{{URL::asset('images/acara/thumbs/'.$acara->img)}}"  
            </td>
              </div>
          </div>
          ...
          <div class='form-group clearfix'>
            {{ Form::label("biaya", "Biaya", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::text("biaya", null,['class' => 'form-control required']) }}
