...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css">
  ...
  <section class="content">
    ...
    {{ Form::open(array('url' => 'biodata_guru_aliyah/create', 'files' => true, 'method' => 'post')) }}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("tempat_lahir", "Tempat Lahir", ['class' => 'col-md-2 control-label']) }}
             <div class='col-md-4'>
                <input type="text" id="tempat_lahir" name="tempat_lahir" class="required datepicker2" )}}'/>
          ...
          <div class='form-group clearfix'>
            ...
            <div class='col-md-4'>
                <input type="text" id="tanggal_lahir" name="tanggal_lahir" class="required datepicker2" )}}'/>
          ...
          <div class='form-group clearfix'>
            {{ Form::label("awal_masuk", "Awal mengajar", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                <input type="date" id="awal_masuk" name="awal_masuk" class="required datepicker2" )}}'/>
