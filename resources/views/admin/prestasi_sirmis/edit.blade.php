...
@section('content')
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
      	{!! Form::model($prestasi_sirmis,['files'=>true,'method'=>'put','action'=>['admin\PrestasiController@update',$prestasi_sirmis->id]]) !!}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("jenis", "Jenis Prestasi", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::text("jenis", null,['class' => 'form-control required']) }}
