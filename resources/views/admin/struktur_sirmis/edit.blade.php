...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
      	{!! Form::model($struktur_sirmis,['files'=>true,'method'=>'put','action'=>['admin\StrukturController@update',$struktur_sirmis->id]]) !!}
          
          <div class='form-group clearfix'>
            {{ Form::label("isi", "Struktur Pesantren", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-9'>
                {{ Form::textarea("isi", null,['class' => 'form-control required', 'id' => 'deskripsi']) }}
