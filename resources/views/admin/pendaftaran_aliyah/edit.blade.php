  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li class="active"><a href="{{URL::to('pendaftaran_aliyah/index')}}">List Pendaftaran</a></li>
    </ol>
  </section></br></br>
  <section class="content">
    <div class="row">
      <div class="col-md-12">
      	{!! Form::model($pendaftaran_aliyah,['files'=>true,'method'=>'put','action'=>['admin\PendaftaranAliyahController@update',$pendaftaran_aliyah->id]]) !!}
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::text("nm_lengkap", null,['class' => 'form-control required', 'placeholder' => 'Masukan Nama Lengkap']) }}
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::text("tempat_lahir", null,['class' => 'form-control required', 'placeholder' => 'Masukan Kota Kelahiran']) }}
                                ...
                                {{ Form::label("tanggal_lahir", "Tanggal Lahir", ['class' => 'col-md-2 control-label']) }}
                                  <div class='col-md-4'>
                                    <input type="text" id="tanggal_lahir" name="tanggal_lahir" class="datepicker" value="{{$pendaftaran_aliyah->tanggal_lahir}}" )}}'/>
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::textarea("alamat_siswa", null,['class' => 'form-control required', 'placeholder' => 'Masukan Alamat Lengkap']) }}
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::text("no_tlp", null,['class' => 'form-control required', 'placeholder' => 'Masukan No Handphone']) }}
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                  {{ Form::label("photo", "Photo", ['class' => 'col-md-2 control-label']) }}
                                    <div class='col-md-4'>
                                      ...
                                      <td>
                                          <img style="width:40%" src="{{URL::asset('images/pendaftaran/aliyah/'.$pendaftaran_aliyah->photo)}}" >
                                      </td>
                                    </div>
                                </div>    
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::text("tmpt_lahir_ibu", null,['class' => 'form-control required', 'placeholder' => 'Masukan Tempat Lahir Ibu']) }}
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::textarea("alamat_ibu", null,['class' => 'form-control required', 'placeholder' => 'Masukan Alamat Ibu']) }}
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::text("no_tlp_ibu", null,['class' => 'form-control required', 'placeholder' => 'Kosongkan Jika tidak Ada']) }}
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::text("nama_ayah", null,['class' => 'form-control required', 'placeholder' => 'Masukan Nama Ayah']) }}
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::text("tmpt_lahir_ayah", null,['class' => 'form-control required', 'placeholder' => 'Masukan Tempat Lahir Ayah']) }}
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::textarea("alamat_ayah", null,['class' => 'form-control required', 'placeholder' => 'Masukan Alamat Ayah']) }}
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                    ...
                                    <div class='col-md-4' style="position: relative;top: 10px; width: 300px">
                                      {{ Form::text("no_tlp_ayah", null,['class' => 'form-control required', 'placeholder' => 'Kosongkan Jika tidak Ada']) }}
