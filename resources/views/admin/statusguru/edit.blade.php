...
@section('content')
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        {!! Form::model($status_guru,['files' => true, 'method'=>'put','action'=>['admin\StatusGuruController@update',$status_guru->id]]) !!}
          
          <div class='form-group clearfix'>
            {{ Form::label("status_guru", "Status Guru", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::text("status_guru", null,['class' => 'form-control required']) }}
