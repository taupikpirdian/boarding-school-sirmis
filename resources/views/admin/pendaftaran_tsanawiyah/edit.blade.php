...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
      	{!! Form::model($pendaftaran_tsanawiyah,['files'=>true,'method'=>'put','action'=>['admin\PendaftaranTsanawiyahController@update',$pendaftaran_tsanawiyah->id]]) !!}
                                ...
                                {{ Form::label("tanggal_lahir", "Tanggal Lahir", ['class' => 'col-md-2 control-label']) }}
                                  <div class='col-md-4'>
                                    <input type="text" id="tanggal_lahir" name="tanggal_lahir" class="datepicker" value="{{$pendaftaran_tsanawiyah->tanggal_lahir}}" )}}'/>
                                ...
                                <div class='form-group clearfix' style="position: relative; left: 10%;">
                                  {{ Form::label("photo", "Photo", ['class' => 'col-md-2 control-label']) }}
                                    <div class='col-md-4'>
                                      ...
                                      <td>
                                          <img style="width:40%" src="{{URL::asset('images/pendaftaran/tsanawiyah/'.$pendaftaran_tsanawiyah->photo)}}" >
                                      </td>
                                    </div>
                                </div>    
