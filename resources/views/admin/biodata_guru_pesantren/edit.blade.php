...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        {!! Form::model($biodata_guru_pesantren,['files'=>true,'method'=>'put','action'=>['admin\BiodataGuruPesantrenController@update',$biodata_guru_pesantren->id]]) !!}
          ...
          <div class='form-group clearfix'>
              {{ Form::label("tanggal_lahir", "Tanggal Lahir", ['class' => 'col-md-2 control-label']) }}
                <div class='col-md-4'>
                  <input type="text" id="tanggal_lahir" name="tanggal_lahir" class="datepicker" value="{{$biodata_guru_pesantren->tanggal_lahir}}" )}}'/>
         ...
         <div class='form-group clearfix'>
          ...
          <div class='form-group clearfix'>
            {{ Form::label("awal_masuk", "Awal Masuk", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                <input type="text" id="awal_masuk" name="awal_masuk" class="datepicker2" value="{{$biodata_guru_pesantren->awal_masuk}}")}}'/>
          ...
          <div class='form-group clearfix'>
            {{ Form::label("img", "Foto", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                ...
                <td>
                    <img style="width:25%" src="{{URL::asset('images/biodataguru/pesantren/'.$biodata_guru_pesantren->img)}}" >
                </td>
              </div>
          </div>
