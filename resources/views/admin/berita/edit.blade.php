...
@section('content')
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        {!! Form::model($berita,['files' => true, 'method'=>'put','action'=>['admin\BeritaController@update',$berita->id]]) !!}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("isi", "Berita", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-9'>
          ...
          <div class='form-group clearfix'>
            {{ Form::label("img", "Gambar", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                ...
                <td>
                    <img style="width:70%" src="{{URL::asset('images/berita/'.$berita->img)}}" >
                </td>
              </div>
          </div>
          <br>
          ...
          <div class='form-group clearfix'>
            {{ Form::label("meta_title", "Meta Title", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-9'>
                {{ Form::text("meta_title", null,['class' => 'form-control required', 'placeholder'=>'Masukan kata kunci, bisa berupa judul, idealnya 60 karakter.']) }}
                <span class="error">{{$errors->first('judul')}}</span>
              </div>
          </div>
          ...
          <div class='form-group clearfix'>
            {{ Form::label("meta_desc", "Meta Description", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-9'>
                {{ Form::textarea("meta_desc", null,['class' => 'form-control required', 'placeholder'=>'Masukan inti penjelasan dari berita yang akan diposting, idealnya 130 karakter.']) }}
                <span class="error">{{$errors->first('isi')}}</span>
              </div>
          </div>
