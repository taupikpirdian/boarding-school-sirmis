...
<meta name="description" content="{{ $berita->meta_desc }}" />
...
<!-- Page Title Here -->
<title>{{ $berita->meta_title }} | SIRMIS - Boarding School</title>
<!-- Mobile Specific -->
...
<div class="page-wraper">
   <!-- header -->
        ...
        <div class="sticky-header header-curve main-bar-wraper">
            <div class="main-bar bg-primary clearfix ">
                <div class="container clearfix">
                    <!-- website logo -->
                    <div class="logo-header mostion"><a href="{{ url('/') }}"><img src="{{URL::asset('frontend/images/logo.png')}}" width="193" height="89" alt=""></a></div>
                    <!-- nav toggle button -->
                         ...
                         <a href="{{ url('/') }}">Home</i></a></li>
                            ...
                            <li> <a href="javascript:;">Profil<i class="fa fa-chevron-down"></i></a>
                                <ul class="sub-menu">
									...
									<li> <a href="{{ url('/visi-misi-tujuan-pesantren-sirnamiskin-bandung') }}">Visi Misi & Target</a></li>
                                </ul>
                            </li>
    ...
    <!-- Footer -->
    <footer class="site-footer footer-overlay bg-img-fix" style="background-color: #000; background-image: url(frontend/images/background/bg1.jpg); background-position: center bottom; background-size: cover;">
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6 footer-col-4">
                        <div class="widget widget_about">
                            <div class="logo-footer"><img src="{{URL::asset('frontend/images/Logofooter.png')}}" alt=""></div>
                            ...
                            <ul class="w3-social-icon border w3-social-icon-lg">
								...
								<li><a href="https://wa.me/6285846132417?text=Kak saya mau dong pesan ayam soangnya" style="background-color:#006400" class="fa fa-whatsapp link-btn"></a></li>
