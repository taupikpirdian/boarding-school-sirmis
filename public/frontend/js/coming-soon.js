...
function setFooterSection()
{
	...
	if($windowWidth <= 1920)
	{
		...
		{
			$centerDiv = $('.f-ele-m');
			$marginVal  = $centerDiv.attr('w3-top-pos') ? $centerDiv.attr('w3-top-pos') : 0  ;
			$position  = $centerDiv.attr('w3-position') ? $centerDiv.attr('w3-position') : true  ;
			//alert($position);
			//alert($marginVal);
...
jQuery(document).ready(function() {
	...
	w3Text(['We Are Coming Soon', 'We Are Coming Soon'], "text");
